# -*- coding: utf-8 -*-
"""
Created on Fri Aug 25 20:20:45 2023
...
independent_variables = df_crisis2.columns.difference([dependent_variable, 'Country', 'Crisis', 'Start', 'End', 'Mean_diff', 'Cumulative_diff'])
...
pdf_filename = 'bivariate_regression_results_length_2Y.pdf'
...
print('Regression results saved to bivariate_regression_results_length_2Y.pdf')
