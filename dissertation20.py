...
independent_variables = df_crisis2.columns.difference([dependent_variable, control_variable, 'Country', 'Crisis', 'Start', 'End', 'Mean_diff', 'Cumulative_diff'])
...
pdf_filename = 'bivariate_regression_results_length_2Y_control.pdf'
...
print('Regression results saved to bivariate_regression_results_length_2Y_control.pdf')
