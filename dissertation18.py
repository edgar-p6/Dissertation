# -*- coding: utf-8 -*-
"""
Created on Fri Aug 25 23:56:04 2023
...
independent_variables = df_crisis2.columns.difference([dependent_variable, control_variable, 'Country', 'Crisis', 'Start', 'End', 'length_db', 'Cumulative_diff'])
...
pdf_filename = 'bivariate_regression_results_GDPmean_2Y_control.pdf'
...
print('Regression results saved to bivariate_regression_results_GDPmean_2Y_control.pdf')
