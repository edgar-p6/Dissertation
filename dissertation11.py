...
independent_variables = df_crisis2.columns.difference([dependent_variable, 'Country', 'Crisis', 'Start', 'End', 'length_db'])

# Create a PDF file to save results
pdf_filename = 'bivariate_regression_results_GDP_2Y.pdf'
...
print('Regression results saved to bivariate_regression_results_GDP_2Y.pdf')