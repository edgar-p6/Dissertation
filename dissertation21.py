# -*- coding: utf-8 -*-
"""
Created on Fri Aug 25 23:56:06 2023
...
independent_variables = df_crisis1.columns.difference([dependent_variable, control_variable, 'Country', 'Crisis', 'Start', 'End', 'length_db', 'Mean_diff'])
...
pdf_filename = 'bivariate_regression_results_GDPcumulative_1Y_control.pdf'
...
with PdfPages(pdf_filename) as pdf:
    for ind_var in independent_variables:
        ...
        subset_df = df_crisis1[[dependent_variable, ind_var, control_variable]].dropna()
...
print('Regression results saved to bivariate_regression_results_GDPcumulative_1Y_control.pdf')
